 ...
 * @author PERSONAL
 */
public class FrmDiagTipoDeIngreso extends javax.swing.JDialog {

    /**
     * Creates new form FrmDiagTipoDeIngreso
     */
    public FrmDiagTipoDeIngreso(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmDiagTipoDeIngreso.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmDiagTipoDeIngreso dialog = new FrmDiagTipoDeIngreso(new javax.swing.JFrame(), true);
